...
export default function Traceability() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-foreground">Supply Chain Traceability</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold text-status-success mt-1">285</p>
        </Card>
        <Card className="p-4">
          <p className="text-sm font-medium text-muted-foreground">Mismatches</p>
          <p className="text-2xl font-bold text-status-error mt-1">39</p>
        </Card>
        <Card className="p-4">
          <p className="text-sm font-medium text-muted-foreground">Pending</p>
          <p className="text-2xl font-bold text-status-pending mt-1">18</p>
        </Card>
      </div>
          ...
          <table className="w-full">
            <thead className="border-b border-border">
              <tr>
                ...
                <th className="text-left py-3 px-4 text-sm font-medium text-muted-foreground">Batch Number</th>
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-foreground font-mono">{shipment.batchNo}</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-sm text-foreground">{shipment.supplier}</td>
                  <td className="py-3 px-4">
                    <StatusBadge status={shipment.status} />
                  </td>
                  <td className="py-3 px-4 text-sm text-muted-foreground">{shipment.date}</td>
                </motion.tr>
              ))}
            </tbody>
          </table>
